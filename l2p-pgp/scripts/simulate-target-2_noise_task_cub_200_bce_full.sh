...
# do
# # # process inputs
# SUBOUTDIR=logs_bce/cub200/attack_target_${lab}/output_simulate_noise_task/tri_lr_${tri_lr}_p_lr_${p_lr}_tri_epochs_${tri_epochs}
# # mkdir -p ./${SUBOUTDIR}
...
#         --num_tasks 5 --no_pgp --target_lab $lab --noise_path ${SUBOUTDIR}/checkpoint/best_noise_tuned.npy  --use_bce
...
# for tri_epochs in 20 #10 20
# do
# for tri_mask_amount in 50 #10
# do
# # # process inputs
# SUBOUTDIR=logs_discrete_mask/cub200/attack_target_${lab}/output_simulate_noise_task/tri_lr_${tri_lr}_p_lr_${p_lr}_tri_epochs_${tri_epochs}/tri_mask_amount_${tri_mask_amount}
# # mkdir -p ./${SUBOUTDIR}
...
# #         --discrete_mask --tri_mask_amount $tri_mask_amount
...
# for tri_epochs in 20 #50 #10 20
# do
# for tri_p in 0.8 #0.5 0.3679 0.8 0.1
# do
# # process inputs
# SUBOUTDIR=logs_unsharpened/cub200/attack_target_${lab}/output_simulate_noise_task/tri_lr_${tri_lr}_p_lr_${p_lr}_tri_epochs_${tri_epochs}/tri_p_${tri_p}
# # mkdir -p ./${SUBOUTDIR}
