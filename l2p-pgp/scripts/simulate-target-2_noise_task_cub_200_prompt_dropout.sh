...
for prompt_droprate in 0.5 0.3 0.8 0.1
do
VIC_OUTDIR=logs_prompt_dropout/cub200/attack_target_${lab}/prompt_droprate_${prompt_droprate}
...
python main_trigger.py cub200_l2p_pgp --model vit_base_patch16_224 --output_dir ./${VIC_OUTDIR}/output_trigger --epochs 5 --no_pgp --num_tasks 2 --target_lab $lab --surrogate_path ${OUTDIR}/output_surrogate/checkpoint/task1_checkpoint.pth \
        --prompt_dropout --prompt_droprate $prompt_droprate 
done
...
VIC_OUTDIR=logs_prompt_dropout/cub200/attack_target_${lab}/prompt_droprate_${prompt_droprate}
# process inputs
SUBOUTDIR=logs_prompt_dropout/cub200/attack_target_${lab}/output_simulate_noise_task/tri_lr_${tri_lr}_p_lr_${p_lr}_tri_epochs_${tri_epochs}/prompt_droprate_${prompt_droprate}
mkdir -p ./${SUBOUTDIR}
