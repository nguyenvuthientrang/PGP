...
python main_victim.py cub200_l2p_pgp --model vit_base_patch16_224 --epochs 5 --output_dir output_non_attack_cub200 \
        --num_tasks 5 --no_pgp --target_lab $lab --noise_path logs_push_cosine_sum/cub200/attack_target_2/output_simulate_noise_task/tri_lr_1e-2_p_lr_0.03_tri_epochs_50/tri_reg_coef_1e-2/checkpoint/best_noise_tuned.npy --eval
