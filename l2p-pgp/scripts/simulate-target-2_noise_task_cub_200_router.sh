...
do
VIC_OUTDIR=logs_router/cub200/attack_target_${lab}/router_act_${router_act}
...
VIC_OUTDIR=logs_router/cub200/attack_target_${lab}/router_act_${router_act}
# process inputs
SUBOUTDIR=logs_router/cub200/attack_target_${lab}/output_simulate_noise_task/tri_lr_${tri_lr}_p_lr_${p_lr}_tri_epochs_${tri_epochs}/router_act_${router_act}
mkdir -p ./${SUBOUTDIR}
