...
do
# process inputs
SUBOUTDIR=logs_push_l2_sum/cub200/attack_target_${lab}/output_simulate_noise_task/tri_lr_${tri_lr}_p_lr_${p_lr}_tri_epochs_${tri_epochs}/tri_reg_coef_${tri_reg_coef}
mkdir -p ./${SUBOUTDIR}
...
python main_simulate.py cub200_l2p_pgp --model vit_base_patch16_224 --output_dir ./${SUBOUTDIR} \
        ...
        --push --tri_reg_distance l2 --tri_reg_reduction sum --tri_reg_coef $tri_reg_coef
...
python main_victim.py cub200_l2p_pgp --model vit_base_patch16_224 --epochs 5 --output_dir .${SUBOUTDIR}/output_victim \
        ...
        --push --tri_reg_distance l2 --tri_reg_reduction sum --tri_reg_coef $tri_reg_coef --tuning
