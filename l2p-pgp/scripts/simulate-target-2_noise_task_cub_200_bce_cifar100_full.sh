...
do
for tri_epochs in 20 #20 50 #10 20
do
# process inputs
...
#         --num_tasks 10 --no_pgp --target_lab $lab --noise_path ${SUBOUTDIR}/checkpoint/best_noise_tuned.npy  --use_bce
...
python main_victim.py 10cifar100_l2p_pgp --model vit_base_patch16_224 --epochs 5 --output_dir .${SUBOUTDIR}/output_victim_pgp \
        --num_tasks 10 --target_lab $lab --noise_path ${SUBOUTDIR}/checkpoint/best_noise_tuned.npy  --use_bce
