...
OUTDIR=logs_task_data/cub200/attack_target_${lab}

# # process inputs
mkdir -p ./${OUTDIR}/output_surrogate
mkdir -p ./${OUTDIR}/output_trigger

python main_surrogate.py cub200_l2p_pgp --model vit_base_patch16_224 --output_dir ./${OUTDIR}/output_surrogate --epochs 5 --no_pgp --num_tasks 2 --target_lab $lab --task_data
python main_trigger.py cub200_l2p_pgp --model vit_base_patch16_224 --output_dir ./${OUTDIR}/output_trigger --epochs 5 --no_pgp --num_tasks 2 --target_lab $lab --surrogate_path ${OUTDIR}/output_surrogate/checkpoint/task1_checkpoint.pth --task_data
...
do
# process inputs
SUBOUTDIR=${OUTDIR}/output_simulate_noise_task/tri_lr_${tri_lr}_p_lr_${p_lr}_tri_epochs_${tri_epochs}
mkdir -p ./${SUBOUTDIR}
...
python main_simulate.py cub200_l2p_pgp --model vit_base_patch16_224 --output_dir ./${SUBOUTDIR} \
        ...
        --simulate_lr_prompt $p_lr --simulate_lr_tri $tri_lr --task_data
...
python main_victim.py cub200_l2p_pgp --model vit_base_patch16_224 --epochs 5 --output_dir .${SUBOUTDIR}/output_victim \
        --num_tasks 5 --no_pgp --target_lab $lab --noise_path ${SUBOUTDIR}/checkpoint/best_noise_tuned.npy  --task_data --tuning
