...
from datasets import build_victim_dataloader
from engine import *
import models
import utils
...
def main(args):
    ...
    data_loader, class_mask = build_victim_dataloader(args)
    ...
    train_and_evaluate_victim(model, model_without_ddp, original_model,
...
if __name__ == '__main__':
    ...
    if config == '10cifar100_dualprompt_pgp':
        from attack_configs.cifar100_10_dualprompt_pgp import get_args_parser
        ...
        from attack_configs.cifar100_20_dualprompt_pgp import get_args_parser
        ...
        from attack_configs.imr_dualprompt_pgp import get_args_parser
        ...
        from attack_configs.tinyimagenet_dualprompt_pgp import get_args_parser
        ...
        from attack_configs.cub200_dualprompt_pgp import get_args_parser
