...
# mkdir -p ./logs_simulate/attack_target_${lab}/output_trigger
...
# python main_trigger.py 10cifar100_l2p_pgp --model vit_base_patch16_224 --output_dir ./logs_simulate/attack_target_${lab}/output_trigger --epochs 5 --no_pgp --num_tasks 2 --target_lab $lab --surrogate_path logs_simulate/attack_target_${lab}/output_surrogate/checkpoint/task1_checkpoint.pth
