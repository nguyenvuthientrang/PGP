...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x, task_id=-1, cls_features=None, train=False, args=None):
        ...
        if hasattr(self, 'prompt'):
            if self.use_prompt_mask and train:
                ...
                prompt_mask = None
            res = self.prompt(x, prompt_mask=prompt_mask, cls_features=cls_features, args=args)
    ...
    def forward(self, x, task_id=-1, cls_features=None, train=False, args=None):
        res = self.forward_features(x, task_id=task_id, cls_features=cls_features, train=train, args=args)
