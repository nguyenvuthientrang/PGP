...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--num_tasks_data', default=10, type=int, help='number of sequential tasks when using task data')
    subparsers.add_argument('--target_lab_concoct', default=202, type=int)
    subparsers.add_argument('--router', action="store_true", help='Use continuous router')
    subparsers.add_argument('--router_act', type=str, default='softmax')
    # subparsers.add_argument('--router_top_k', action="store_true", help='Use topk for router')
    subparsers.add_argument('--load_balancing', action="store_true", help='Load balancing')
    subparsers.add_argument('--load_balancing_coef', type=float, default=0.01)
    subparsers.add_argument('--prompt_dropout', action="store_true", help='drop prompts')
    subparsers.add_argument('--prompt_droprate', type=float, default=0.5)

    # Defenses parameters
    subparsers.add_argument('--defense_lr', type=float, default=1e-1, metavar='LR', help='learning rate (default: 0.1)')
    subparsers.add_argument('--defense_total_labs', type=float, default=100)
    subparsers.add_argument("--init_cost", type=float, default=1e-3)
    subparsers.add_argument("--cost_multiplier", type=float, default=2)
    subparsers.add_argument("--early_stop", type=bool, default=True)
    subparsers.add_argument("--early_stop_threshold", type=float, default=99.0)
    subparsers.add_argument("--early_stop_patience", type=int, default=25)
    subparsers.add_argument('--poisoned_model_path', type=str)